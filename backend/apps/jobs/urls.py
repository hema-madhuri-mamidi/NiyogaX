...
urlpatterns = [
    ...
    path("applications/<int:application_id>/confirm/", views.confirm_application, name="confirm_application"),
    path("applications/<int:application_id>/unavailable/", views.mark_unavailable, name="mark_unavailable"),
